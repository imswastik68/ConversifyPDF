...
const features = [
  ...
  },
  {
    ...
    description: "Keep alll your important PDF files securely stored and easily accessible anytime, anywhere.",
    icon: ZapIcon
  },
  {
...
export default function Home() {
  return (
    <div className="flex-1 overflow-scroll bg-gradient-to-bl from-white to-indigo-600  p-2 lg:p-5">
      <main>
        <div className="bg-white py-24 sm:py-32  rounded-md drop-shadow-xl">
          ...
          <div className="mx-auto mt-16 max-w-7xl px-6 sm:mt-20 md:mt-24 lg:px-8">
            <dl className="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 textt-base leading-7 text-gray-600
